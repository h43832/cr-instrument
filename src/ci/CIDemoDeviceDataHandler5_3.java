 ...
 * @author peter
 */
public class CIDemoDeviceDataHandler5_3 implements wsn.WSNSocketDataHandler{
  int deviceN=4;
  TreeMap tm=new TreeMap();

  SimpleDateFormat format=new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
  int inx=0,idInx=0;
  String date=format.format(new Date()),id[]={"K3_235","K3_236","K3_237","K3_238"},coordinatorId="COOR03",dummyId[]={"","","",""};
  public CIDemoDeviceDataHandler5_3(){
