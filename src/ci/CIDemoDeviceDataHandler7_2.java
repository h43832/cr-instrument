 ...
 * @author peter
 */
public class CIDemoDeviceDataHandler7_2 implements wsn.WSNSocketDataHandler{

  TreeMap tm=new TreeMap();

  SimpleDateFormat format=new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
  int inx=0,idInx=0;
  String date=format.format(new Date()),id[]={"K2_235","K2_236","K2_237","K2_238"},coordinatorId="COOR02",dummyId[]={"","","",""};
  public CIDemoDeviceDataHandler7_2(){
