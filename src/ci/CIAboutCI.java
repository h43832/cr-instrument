...
public class CIAboutCI extends javax.swing.JDialog {

    CrInstrument instrument;
    public ResourceBundle bundle2 = java.util.ResourceBundle.getBundle("ci/Bundle");
    public CIAboutCI(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        ...
        Image image= new ImageIcon(getClass().getClassLoader().getResource("cr_instrument_t.gif")).getImage();
        setIconImage(image);
    ...
    private void initComponents() {
        ...
        jLabel3.setText(bundle.getString("CIAboutCI.jLabel3.text")); 
        getContentPane().add(jLabel3);
        jLabel3.setBounds(20, 10, 210, 20);

        jLabel4.setFont(jLabel4.getFont().deriveFont(jLabel4.getFont().getSize()+2f));
        jLabel4.setForeground(new java.awt.Color(0, 102, 153));
        jLabel4.setText(bundle.getString("CIAboutCI.jLabel4.text")); 
        getContentPane().add(jLabel4);
        jLabel4.setBounds(30, 30, 300, 18);

        jLabel5.setText(bundle.getString("CIAboutCI.jLabel5.text")); 
        getContentPane().add(jLabel5);
        jLabel5.setBounds(420, 120, 90, 90);

        jLabel6.setFont(jLabel6.getFont());
        jLabel6.setForeground(new java.awt.Color(0, 0, 255));
        jLabel6.setText(bundle.getString("CIAboutCI.jLabel6.text")); 
